...
class CustomUser(AbstractBaseUser, PermissionsMixin):
    ...
    last_name_kana   = models.CharField(verbose_name="姓フリガナ", max_length=150, blank=True)
    first_name_kana  = models.CharField(verbose_name="名フリガナ", max_length=150, blank=True)
...
class Gender(models.Model):
     ...
     gender = models.CharField(verbose_name="性別", max_length=5, choices=gender_choice,null=True,blank=True)
